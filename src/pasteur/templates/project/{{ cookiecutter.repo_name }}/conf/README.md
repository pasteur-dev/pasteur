# What is this for?
This folder should be used to store configuration files used by Kedro, Pasteur or by separate tools.
...
## Find out more
You can find out more about configuration from Kedro's [user guide documentation](https://kedro.readthedocs.io/en/stable/04_user_guide/03_configuration.html).
